...
let BUSD_WBNB_XPAIR = "0x6a8c5a058185f24ff99b46ac628ff1b5a16543a3"; // created block 14978771
let USDT_WBNB_XPAIR = "0x4787d0c91a6618e9282d3b0d61a43ff9a3a81a92"; // created block 15240684

export function getBnbPriceInUSD(): BigDecimal {
  // fetch eth prices for each stablecoin
  let usdtPair = Pair.load(USDT_WBNB_XPAIR); // usdt is token0
  let busdPair = Pair.load(BUSD_WBNB_XPAIR); // busd is token1
